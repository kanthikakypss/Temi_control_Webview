        ...
        OnSdkExceptionListener
{
    ...
    public static final String HOME_BASE_LOCATION = "home base" , ACTION_HOME_A = "a", ACTION_HOME_B = "b", ACTION_HOME_C = "c", ACTION_HOME_D = "god";
    // Storage Permissions
...
//            }
    ...
    public void onNlpCompleted(NlpResult nlpResult) {
        ...
        switch (nlpResult.action) {
            ...
            case ACTION_HOME_A:
                robot.goTo(ACTION_HOME_A);
                break;

            case ACTION_HOME_B:
                robot.goTo(ACTION_HOME_B);
                break;

            case ACTION_HOME_C:
                robot.goTo(ACTION_HOME_C);
                break;

            case ACTION_HOME_D:
                robot.goTo(ACTION_HOME_D);
                break;
        }
    }
...
//                break;
            ...
            case OnGoToLocationStatusChangedListener.GOING:
                robot.speak(TtsRequest.create("กำ ลัง ไป ยัง" + location, false));
                break;
